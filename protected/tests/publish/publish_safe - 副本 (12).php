...
Eof;
			//$this->runScript('var div=document.getElementById("lg");var span=document.createElement("a");span.id="spanid";span.href="http://www.baidu.com/";span.innerHTML=" i am append span !";div.appendChild(span);');
			$this->runScript($js);
...
Eof;
				...
				if($temTex == "已发布到淘宝")
				{
					file_put_contents("tesList.data","确实发布成功了" );
				}else
				{
					file_put_contents("tesList.data","未知的发布失败原因" );
				}
				//$this->pause(600000);
